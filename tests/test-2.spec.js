...
await page.getByText('Line of Business--- Choose an').click();
...
await page.getByRole('textbox', { name: 'Search Firm Name' }).fill('Today Test');
...
await page.locator('input[name="effDate2"]').fill('2026-01-12');
...
await page.locator('td:nth-child(4) > .custom-control').first().click();
...
await page.locator('#checkNumber').fill('123586');
await page.getByRole('button', { name: 'Autofill  ($730.00)' }).click();
await page.locator('nb-layout-column').click();
...
await page.getByRole('row', { name: 'REEXP AL TODA001 Today Test' }).getByRole('checkbox').check();
await page.getByRole('button', { name: 'Issue Policy' }).click();
await page.getByRole('button', { name: 'Yes' }).click();
await page.getByRole('link', { name: 'Underwriting' }).click();

await page.getByRole('link', { name: 'Deposit' }).click();
await page.locator('.ng2-smart-actions > .form-control').first().check();
...
await page.getByRole('row', { name: 'Ready to Book REEXP TODA003' }).getByRole('checkbox').check();
await page.getByRole('button', { name: 'Mark For Booking' }).click();
await page.getByRole('button', { name: 'Yes' }).click();
await page.goto('https://www.landydev.com/#/pages/bookingBatchTab/BookingBatch');
await page.getByRole('cell', { name: '  ' }).first().click();
await page.getByRole('button', { name: 'Yes' }).click();
await page.getByRole('link', { name: 'Underwriting' }).click();
await page.getByText('Today Test1').click();
});